...
model.q{1} = HipsJoint.rxyz(1,:);
model.q{2} = HipsJoint.rxyz(2,:);
model.q{3} = HipsJoint.rxyz(3,:);
model.qd{1} = HipsJoint.rxyz1(1,:);
model.qd{2} = HipsJoint.rxyz1(2,:);
model.qd{3} = HipsJoint.rxyz1(3,:);
model.qdd{1} = HipsJoint.rxyz2(1,:);
model.qdd{2} = HipsJoint.rxyz2(2,:);
model.qdd{3} = HipsJoint.rxyz2(3,:);

model.Xtree{4} = xlt([ChestJoint.offset]);
model.Xtree{5} = xlt([0 0 0]);
model.Xtree{6} = xlt([0 0 0]);
model.q{4} = ChestJoint.rxyz(1,:);
model.q{5} = ChestJoint.rxyz(2,:);
model.q{6} = ChestJoint.rxyz(3,:);
model.qd{4} = ChestJoint.rxyz1(1,:);
model.qd{5} = ChestJoint.rxyz1(2,:);
model.qd{6} = ChestJoint.rxyz1(3,:);
model.qdd{4} = ChestJoint.rxyz2(1,:);
model.qdd{5} = ChestJoint.rxyz2(2,:);
model.qdd{6} = ChestJoint.rxyz2(3,:);

model.Xtree{7} = xlt([Chest2Joint.offset]);
model.Xtree{8} = xlt([0 0 0]);
model.Xtree{9} = xlt([0 0 0]);
model.q{7} = Chest2Joint.rxyz(1,:);
model.q{8} = Chest2Joint.rxyz(2,:);
model.q{9} = Chest2Joint.rxyz(3,:);
model.qd{7} = Chest2Joint.rxyz1(1,:);
model.qd{8} = Chest2Joint.rxyz1(2,:);
model.qd{9} = Chest2Joint.rxyz1(3,:);
model.qdd{7} = Chest2Joint.rxyz2(1,:);
model.qdd{8} = Chest2Joint.rxyz2(2,:);
model.qdd{9} = Chest2Joint.rxyz2(3,:);

model.Xtree{10} = xlt([Chest3Joint.offset]);
model.Xtree{11} = xlt([0 0 0]);
model.Xtree{12} = xlt([0 0 0]);
model.q{10} = Chest3Joint.rxyz(1,:);
model.q{11} = Chest3Joint.rxyz(2,:);
model.q{12} = Chest3Joint.rxyz(3,:);
model.qd{10} = Chest3Joint.rxyz1(1,:);
model.qd{11} = Chest3Joint.rxyz1(2,:);
model.qd{12} = Chest3Joint.rxyz1(3,:);
model.qdd{10} = Chest3Joint.rxyz2(1,:);
model.qdd{11} = Chest3Joint.rxyz2(2,:);
model.qdd{12} = Chest3Joint.rxyz2(3,:);
